...
const Aboutus = () => {
  return (
    <div className='container abtus d-flex flex-column justify-content-center align-items-center mt-5 mb-5'>
      ...
      <p className='abtPara col-8 my-4'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel corporis, ipsa, nihil quibusdam aperiam consequuntur enim labore aut veniam excepturi natus magni maxime rerum ab. Laborum delectus soluta corrupti officiis!</p>
