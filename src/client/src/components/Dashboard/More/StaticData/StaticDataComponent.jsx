...
export default function StaticDataComponent(props) {
    ...
    <div className="container mt-5">
      <div className="card lgcard border-0" style={{ borderColor: 'rgb(250, 199, 170)' }}>
        <div className="row" style={{ marginLeft: '25px', backgroundColor: '#ffffff', border: '40px solid rgb(250, 199, 170)', display: 'flex', alignItems: 'stretch', height: '500px', width: '1000px' }}>
